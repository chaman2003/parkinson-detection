...
console.log('🔧 Vercel Build: Injecting environment variables...');
...
if (!backendUrl) {
    ...
    console.error('Example: https://elease-unmeaning-mireille.ngrok-free.dev');
    process.exit(1);
}
...
console.log('🌐 Vercel Environment: Backend URL configured');
`;
...
try {
    ...
    console.log('✅ Created vercel-env.js with backend URL');
} catch (error) {
    console.error('❌ Failed to create vercel-env.js:', error);
    process.exit(1);
}
